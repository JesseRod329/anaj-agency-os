...
// MARK: - OpenClaw Realtime Envelope Models
...
struct OpenClawCommandEnvelope: Codable, Sendable {
    let type: String
    let id: String
    let command: String
...
struct OpenClawAckEnvelope: Codable, Sendable {
    let type: String
    let id: String
...
struct OpenClawEventEnvelope: Codable, Sendable {
    let type: String
    let event: String
    let entity: String
    let entityId: String?
